...
class JsMinifyTest extends TestCase
{
    ...
    public function testBasicMinification()
    {
        ...
        $this->assertTrue(file_exists($basePath . 'output.js'));
        ...
        $expectedLog = 'Minified JS from <info>' . $source . '</info> to <info>' . $dest . '</info>';
        $this->assertEquals(
            $expectedLog,
    ...
    public function testImportWithChainedState()
    {
        ...
        $expected = [
            $basePath . 'simple.js' => [
                'js' => "var msg='Hello';alert(msg);var thisIsABool=!0",
                'destination' => $basePath . 'output.js'
            ]
        ];
    ...
    public function testMultipleSourcesImport()
    {
        ...
        $sentenceStart = 'Minified JS from';
        ...
        $source = $basePath . 'more-complex.js';
        $destination = $basePath . 'deep' . DS . 'output-complex.js';
        $expectedLog = $sentenceStart . ' <info>' . $source . '</info> to <info>' . $destination . '</info>';
        $this->assertEquals(
            $expectedLog,
